...
contract Verifier {
    ...
    uint256 constant ALPHA_X =
        2559308884662736696126415682046798600569001386110428081918047700024919464375;
    uint256 constant ALPHA_Y =
        19292665326173889308608033211468034726755071579388877951189979612539000872371;

    // Groth16 beta point in G2 in powers of i
    uint256 constant BETA_NEG_X_0 =
        19867048179793149982520356600153287990399471240735737349478137935694658872849;
    uint256 constant BETA_NEG_X_1 =
        258300369616281673638731348006387378872519885096679567494290139459588602910;
    uint256 constant BETA_NEG_Y_0 =
        7968918895964235355806488306394416293112019252760605816849869214880805728414;
    uint256 constant BETA_NEG_Y_1 =
        2692111711823417672622472757676777441013266274589444461941409075713970347509;

    // Groth16 gamma point in G2 in powers of i
    uint256 constant GAMMA_NEG_X_0 =
        16220457396435034576723456228848488122329148325010179089314385891103305203464;
    uint256 constant GAMMA_NEG_X_1 =
        16061408113100737360657827071250701463296637103619243908818629781458234151957;
    uint256 constant GAMMA_NEG_Y_0 =
        19277801108029698620518773284081667625744413961518656909052700837017121673415;
    uint256 constant GAMMA_NEG_Y_1 =
        6291466155289079551423915730276314146464117956482374662146662136676202546304;

    // Groth16 delta point in G2 in powers of i
    uint256 constant DELTA_NEG_X_0 =
        10758820431080696090231805941341339962213994014305582564087024011897823267684;
    uint256 constant DELTA_NEG_X_1 =
        2373141708306594927472088590654585593475087712341764774932769264346477323149;
    uint256 constant DELTA_NEG_Y_0 =
        8581888006405971916135835102116548719382800610888429175395219978725472199146;
    uint256 constant DELTA_NEG_Y_1 =
        1344806624676813760501109211950442155281184351804248129060364116030216642520;

    // Constant and public input points
    uint256 constant CONSTANT_X =
        12672984073737716206841482213368223098610735267746226780221093647735293317860;
    uint256 constant CONSTANT_Y =
        579968861536295841329520126552050349294345273442720031208689606770137285572;
    uint256 constant PUB_0_X =
        15308966018682194919066733321357170139511213194356680662205977684569705502041;
    uint256 constant PUB_0_Y =
        14472272287473281872804285084771340256534601238376873679189589397030035350822;
    uint256 constant PUB_1_X =
        6056748138760410881717766087974316444680157334588068026786462513664962032522;
    uint256 constant PUB_1_Y =
        2879264679861792233250874850830780773692848720578975461457818918331941633662;
